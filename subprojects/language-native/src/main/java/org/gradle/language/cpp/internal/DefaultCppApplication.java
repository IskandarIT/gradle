...
public class DefaultCppApplication extends DefaultCppComponent implements CppApplication, PublicationAwareComponent {
    ...
    @Inject
    public DefaultCppApplication(String name, ObjectFactory objectFactory, FileOperations fileOperations, TargetMachineFactory targetMachineFactory, CollectionCallbackActionDecorator collectionCallbackActionDecorator) {
